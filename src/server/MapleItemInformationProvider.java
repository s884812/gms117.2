...
public class MapleItemInformationProvider {
    ...
    public void runEtc() {
        ...
        for (MapleData dat : setsData) {
            ...
            itemz.setItemID = (byte) Short.parseShort(dat.getName());
    ...
    public void runItems() {
        ...
        System.out.println( "·物品信息加载‖总计【" + dataCache.size() + "】件物品");
    }
        ...
        if (item.equipStats.size() > 0) {
            for (Entry<String, Integer> stat : item.equipStats.entrySet()) {
                ...
                if (key.equals("STR")) {
                    ...
                    item.eq.sethpr(stat.getValue().shortValue());
                } else if (key.equals("MMPr")) {
                    item.eq.setmpr(stat.getValue().shortValue());
                }
            }
