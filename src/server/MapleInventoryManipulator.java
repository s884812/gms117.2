...
public class MapleInventoryManipulator {
    ...
    public static boolean addById(MapleClient c, int itemId, short quantity) {
        return addById(c, itemId, (short) quantity, "Pokemon prize on HELL on " + FileoutputUtil.CurrentReadable_Date());
    }
 ...
 return;
        ...
        } else if (source.getItemId() == 1122086) {
            chr.startFairySchedule(true, true);
        } else if (source.getItemId() == 1122155) {
            chr.startFairySchedule(true, true);
        } else if (source.getItemId() == 1122156) {
            chr.startFairySchedule(true, true);
        } else if (source.getItemId() == 1122214) {
            chr.startFairySchedule(true, true);
        } else if (source.getItemId() == 1122171) {
            chr.startFairySchedule(true, true);
        } else if (source.getItemId() == 1122172) {
            chr.startFairySchedule(true, true);
        }
    ...
    public static void unequip1(final MapleClient c, final short src, short dst) {
        Equip source = (Equip) c.getPlayer().getInventory(MapleInventoryType.EQUIPPED).getItem(src);
        Equip target = (Equip) c.getPlayer().getInventory(MapleInventoryType.EQUIP).getItem(dst);
