...
import static server.quest.MapleQuestRequirementType.charismaMin;
import static server.quest.MapleQuestRequirementType.charmMin;
import static server.quest.MapleQuestRequirementType.craftMin;
import static server.quest.MapleQuestRequirementType.dayByDay;
import static server.quest.MapleQuestRequirementType.end;
import static server.quest.MapleQuestRequirementType.fieldEnter;
import static server.quest.MapleQuestRequirementType.insightMin;
import static server.quest.MapleQuestRequirementType.interval;
import static server.quest.MapleQuestRequirementType.item;
import static server.quest.MapleQuestRequirementType.job;
import static server.quest.MapleQuestRequirementType.lvmax;
import static server.quest.MapleQuestRequirementType.lvmin;
import static server.quest.MapleQuestRequirementType.mbcard;
import static server.quest.MapleQuestRequirementType.mbmin;
import static server.quest.MapleQuestRequirementType.mob;
import static server.quest.MapleQuestRequirementType.normalAutoStart;
import static server.quest.MapleQuestRequirementType.npc;
import static server.quest.MapleQuestRequirementType.partyQuest_S;
import static server.quest.MapleQuestRequirementType.pet;
import static server.quest.MapleQuestRequirementType.pettamenessmin;
import static server.quest.MapleQuestRequirementType.pop;
import static server.quest.MapleQuestRequirementType.quest;
import static server.quest.MapleQuestRequirementType.questComplete;
import static server.quest.MapleQuestRequirementType.senseMin;
import static server.quest.MapleQuestRequirementType.skill;
import static server.quest.MapleQuestRequirementType.subJobFlags;
import static server.quest.MapleQuestRequirementType.willMin;
import tools.Pair;
