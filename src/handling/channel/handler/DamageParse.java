...
import constants.skills.Cygnus.DawnWarrior;
import constants.skills.Cygnus.WindArcher;
...
/*      */           case 14111002:
/*      */           case 14111005:
/*  310 */             int[] skills = { 4120005, 4220005, 4340001, 14110004, 4320005};
...
/*  944 */                 if ((((Integer)eachd.left).intValue() > 210000000) || (Randomizer.nextInt(100) < CriticalRate)) {
/*  945 */                   toCrit++;
/*      */                 }
...
/* 1098 */     lea.skip(4);
/* 1099 */     lea.skip(1);
/* 1100 */     if ((ret.skill == 5300007) || (ret.skill == 24121005) || (ret.skill == 5101012) || (ret.skill == 5081001) || (ret.skill == 15101010)) {
/* 1101 */       lea.readInt();
/*      */     }
...
/* 1219 */     if (ret.hits == 0) {
    ...
    for (int i = 0; i < ret.targets; i++) {
      ...
      for (int j = 0; j < bullets; j++) {
        int damage = lea.readInt();
        if (chr.isAdmin()) {
          chr.dropMessage(-5, new StringBuilder().append("金钱炸弹攻击怪物: ").append(ret.targets).append(" 攻击次数: ").append(bullets).append(" 打怪伤害: ").append(damage).toString());
        }
        allDamageNumbers.add(new Pair(Integer.valueOf(damage), Boolean.valueOf(false)));
      }
      ret.allDamage.add(new AttackPair(Integer.valueOf(oid).intValue(), allDamageNumbers));
