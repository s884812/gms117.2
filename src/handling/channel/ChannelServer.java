...
public class ChannelServer {
    ...
    private int expRate, mesoRate, dropRate = 1, cashRate = 1, traitRate = 1, BossDropRate = 3; 
    ...
    public final void run_startup_configurations() {
        ...
        try {
            ...
            stateRate = Integer.parseInt(ServerProperties.getProperty("net.sf.odinms.world.stateRate"));
        ...
        try {
            ...
            System.out.println("·频道服务器信息‖频道：" + getChannel() + e + " ‖端口："+ port + " ‖启动失败...");
        }
    }
