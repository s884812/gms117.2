...
public class LoginInformationProvider {
    ...
    public enum JobType { 
        UltimateAdventurer(-1, "Ultimate", 0, 130000000),//骑士团
        Resistance(0, "Resistance", 3000, 931000000),//反抗者
        Adventurer(1, "", 0, 0),//冒险家
        Cygnus(2, "Premium", 1000, 130030000 ), //913040000
        Aran(3, "Orient", 2000, 914000000),//战神
        Evan(4, "Evan", 2001, 900090000),//龙神
        Mercedes(5, "", 2002, 910150000),
        Demon(6, "", 3001, 931050310),
        Phantom(7, "", 2003, 104000000),//幻影
        DualBlade(8, "", 0, 103050900),//双刀
        Mihile(9, "", 5000, 104000000),//米哈尔
        Jett(10, "", 0, 552000010),//铁胆火车侠
