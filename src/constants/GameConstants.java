...
/*      */     
    ...
    public static boolean iszhuan(final int id) {
        switch (id) {
            case 2430033:
            case 2430026:
            case 2430157:
    ...
    public static int[] Equipments_Bonus = {1122017,1122086,1122155,1122156,1122214,1122171,1122172};
    ...
    public static boolean potentialIDFits(final int potentialID, final int newstate, final int i) {//潜能列表
		...
		if (newstate == 20) {//ss
			return (i == 0 || (potentialID >= 40041) && (potentialID < 60004)); // xml say so
        } else if (newstate == 19) {//s
            return (i == 0 || (potentialID >= 30000) && (potentialID < 60000));
            //return (i == 0 || potentialID >= 40001 && potentialID <= 42656);
        } else if (newstate == 18) {//a
            return (i == 0 || (potentialID >= 20000) && (potentialID < 30000));
            //return (i == 0 || potentialID >= 30001 && potentialID <= 32206);
        } else if (newstate == 17) {//b
            return (i == 0 || (potentialID >= 10000) && (potentialID < 30000));
        } else {
            return false;
        }
    }
    ...
    public static boolean isBeginnerJob(final int job) {
        return job == 0 || job == 1 || job == 1000 || job == 2000 || job == 2001 || job == 3000 || job == 3001 || job == 2002 || job == 5000;
    }
    ...
    public static final String[] publicNpcs = {"#c公共NPC#", "Move to the #cBattle Square# to fight other players", "打开次元之境", "去怪物公园", "去自由市场", "去专业村庄",
        "查看这个地图的怪物暴率", "察看怪物手册", "Review #cPokemon#.", "Join an #cevent# in progress."};
