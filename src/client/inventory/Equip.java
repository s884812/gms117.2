...
public class Equip extends Item implements Serializable {
    ...
    private short str = 0, dex = 0, _int = 0, luk = 0, hp = 0, mp = 0, watk = 0, matk = 0, wdef = 0, mdef = 0, acc = 0, avoid = 0, hands = 0, speed = 0, jump = 0, charmExp = 0, pvpDamage = 0, hpr = 0, mpr = 0;
  ...
  public void setStateMsg(int en) {
    ...
    if ((this.potential1 >= 40000) || (this.potential2 >= 40000) || (this.potential3 >= 40000) || (this.potential4 >= 40000) || (this.potential5 >= 40000))
      return 20;
    if ((this.potential1 >= 30000) || (this.potential2 >= 30000) || (this.potential3 >= 30000) || (this.potential4 >= 30000) || (this.potential5 >= 30000))
      return 19;
    if ((this.potential1 >= 20000) || (this.potential2 >= 20000) || (this.potential3 >= 20000) || (this.potential4 >= 20000) || (this.potential5 >= 20000))
      return 18;
    if (pots >= 1)
      return 17;
    if (pots < 0) {
