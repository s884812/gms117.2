...
public class PlayerCommand {
    ...
    public static class zidong extends CommandExecute {
        ...
        public int execute(MapleClient c, String[] splitted) {
            if (c.getPlayer().getzidong() == 1) {
                                                c.getPlayer().gainzidong(-1);
                                                c.getPlayer().dropMessage(5,"已经成功关闭自动捡钱！");
                                        } else {
                                                c.getPlayer().gainzidong(1);
                                                c.getPlayer().dropMessage(5,"已经成功开启自动捡钱！");
                                        }
            return 1;
        }
    }
    ...
    public static class ReloadEvent extends CommandExecute {
