...
function invasion() {
    ...
    if(numspawn > 0) {
        ...
        Boat_to_Orbis.broadcastMessage(CWvsContext.boatPacket(true));
        Boat_to_Ellinia.broadcastMessage(CWvsContext.boatPacket(true));
        Boat_to_Orbis.broadcastMessage(CWvsContext.musicChange("Bgm04/ArabPirate"));
        Boat_to_Ellinia.broadcastMessage(CWvsContext.musicChange("Bgm04/ArabPirate"));
